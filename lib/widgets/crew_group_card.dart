...
class CrewGroupCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const avatarColors = [Color(0xFFFFB5A6), Color(0xFFD8C5FF), Color(0xFFAEC8E8)];
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            child: Stack(
              children: [
                for (var index = 0; index < avatarCount; index++)
                  Positioned(
                    left: index * 25.0,
                    child: _MemberAvatar(color: avatarColors[index % avatarColors.length]),
                  ),
          ...
          Text('$memberCount Members', style: const TextStyle(fontSize: 14, color: Color(0xFF60636D))),
...
class _OverflowAvatar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Text('+$count', style: const TextStyle(fontSize: 17, fontWeight: FontWeight.w700)),
    );
  }
}
